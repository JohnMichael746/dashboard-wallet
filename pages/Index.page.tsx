                ...
                <div className="grid gap-6 mb-6 sm:grid-cols-2 xl:grid-cols-3">
                        ...
                        <div className="space-y-9">
                            <div className="flex items-center">
                                <div className="w-9 h-9 ltr:mr-3 rtl:ml-3">
                                    <div className="grid rounded-full bg-secondary-light dark:bg-secondary text-secondary dark:text-secondary-light w-9 h-9 place-content-center">
                            ...
                            <div className="flex items-center">
                                <div className="w-9 h-9 ltr:mr-3 rtl:ml-3">
                                    <div className="grid rounded-full bg-success-light dark:bg-success text-success dark:text-success-light w-9 h-9 place-content-center">
                                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path
                            ...
                            <div className="flex items-center">
                                <div className="w-9 h-9 ltr:mr-3 rtl:ml-3">
                                    <div className="grid rounded-full bg-warning-light dark:bg-warning text-warning dark:text-warning-light w-9 h-9 place-content-center">
                                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path
                    ...
                    <div className="h-full p-0 panel">
                        <div className="absolute flex items-center justify-between w-full p-5">
                            <div className="relative">
                                <div className="flex items-center justify-center rounded-lg text-success dark:text-success-light bg-success-light dark:bg-success w-11 h-11">
                ...
                <div className="grid gap-6 mb-6 sm:grid-cols-2 xl:grid-cols-3">
                    <div className="h-full pb-0 panel sm:col-span-2 xl:col-span-1">
                        ...
                        <PerfectScrollbar className="relative h-[290px] pr-3 -mr-3 mb-4">
                            <div className="text-sm cursor-pointer">
                                <div className="flex items-center py-1.5 relative group">
                                    ...
                                    <div className="text-xs ltr:ml-auto rtl:mr-auto text-white-dark dark:text-gray-500">Just Now</div>

                                    <span className="absolute text-xs opacity-0 badge badge-outline-primary ltr:right-0 rtl:left-0 bg-primary-light dark:bg-black group-hover:opacity-100">
                                        Pending
                                    </span>
                                </div>
                                <div className="flex items-center py-1.5 relative group">
                                    ...
                                    <div className="text-xs ltr:ml-auto rtl:mr-auto text-white-dark dark:text-gray-500">2 min ago</div>

                                    <span className="absolute text-xs opacity-0 badge badge-outline-success ltr:right-0 rtl:left-0 bg-success-light dark:bg-black group-hover:opacity-100">
                                        Completed
                                    </span>
                                </div>
                                <div className="flex items-center py-1.5 relative group">
                                    ...
                                    <div className="text-xs ltr:ml-auto rtl:mr-auto text-white-dark dark:text-gray-500">14:00</div>

                                    <span className="absolute text-xs opacity-0 badge badge-outline-danger ltr:right-0 rtl:left-0 bg-danger-light dark:bg-black group-hover:opacity-100">Pending</span>
                                </div>
                                <div className="flex items-center py-1.5 relative group">
                                    ...
                                    <div className="text-xs ltr:ml-auto rtl:mr-auto text-white-dark dark:text-gray-500">16:00</div>

                                    <span className="absolute text-xs opacity-0 badge badge-outline-dark ltr:right-0 rtl:left-0 bg-dark-light dark:bg-black group-hover:opacity-100">Completed</span>
                                </div>
                                <div className="flex items-center py-1.5 relative group">
                                    ...
                                    <div className="text-xs ltr:ml-auto rtl:mr-auto text-white-dark dark:text-gray-500">17:00</div>

                                    <span className="absolute text-xs opacity-0 badge badge-outline-warning ltr:right-0 rtl:left-0 bg-warning-light dark:bg-black group-hover:opacity-100">
                                        In progress
                                    </span>
                                </div>
                                <div className="flex items-center py-1.5 relative group">
                                    ...
                                    <span className="absolute text-xs opacity-0 badge badge-outline-info ltr:right-0 rtl:left-0 bg-info-light dark:bg-black group-hover:opacity-100">Completed</span>
                                </div>
                                <div className="flex items-center py-1.5 relative group">
                                    ...
                                    <div className="text-xs ltr:ml-auto rtl:mr-auto text-white-dark dark:text-gray-500">18:00</div>

                                    <span className="absolute text-xs opacity-0 badge badge-outline-secondary ltr:right-0 rtl:left-0 bg-secondary-light dark:bg-black group-hover:opacity-100">
                                        Pending
                                    </span>
                                </div>
                                <div className="flex items-center py-1.5 relative group">
                        ...
                        <div className="border-t border-white-light dark:border-white/10">
                            <Link to="/" className="flex items-center justify-center p-4 font-semibold  group hover:text-primary">
                                View All
                                <svg
                                    className="w-4 h-4 transition duration-300 rtl:rotate-180 group-hover:translate-x-1 rtl:group-hover:-translate-x-1 ltr:ml-1 rtl:mr-1"
                                    viewBox="0 0 24 24"
                                    fill="none"
                    ...
                    <div className="h-full panel">
                        ...
                        <div>
                            <div className="space-y-6">
                                <div className="flex">
                                    <span className="grid text-base rounded-md place-content-center w-9 h-9 bg-success-light dark:bg-success text-success dark:text-success-light">SP</span>
                                ...
                                <div className="flex">
                                    <span className="grid rounded-md place-content-center w-9 h-9 bg-warning-light dark:bg-warning text-warning dark:text-warning-light">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path
                                ...
                                <div className="flex">
                                    <span className="grid rounded-md place-content-center w-9 h-9 bg-danger-light dark:bg-danger text-danger dark:text-danger-light">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div className="flex">
                                    <span className="grid rounded-md place-content-center w-9 h-9 bg-secondary-light dark:bg-secondary text-secondary dark:text-secondary-light">
                                ...
                                <div className="flex">
                                    <span className="grid text-base rounded-md place-content-center w-9 h-9 bg-info-light dark:bg-info text-info dark:text-info-light">DA</span>
                                    <div className="flex-1 px-3">
                                ...
                                <div className="flex">
                                    <span className="grid rounded-md place-content-center w-9 h-9 bg-primary-light dark:bg-primary text-primary dark:text-primary-light">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path
                    ...
                    <div className="h-full p-0 overflow-hidden border-0 panel">
                        <div className="p-6 bg-gradient-to-r from-[#4361ee] to-[#160f6b] min-h-[190px]">
                            <div className="flex items-center justify-between mb-6">
                                ...
                                <button type="button" className="flex items-center justify-between text-white bg-black rounded-md ltr:ml-auto rtl:mr-auto w-9 h-9 hover:opacity-80">
                            ...
                            <table>
                                ...
                                <tbody>
                                    ...
                                    <tr className="text-white-dark hover:text-black dark:hover:text-white-light/90 group">
                                        ...
                                        <td>130</td>
                                        <td>
                                            <Link className="flex items-center text-success" to="/">
                                                <svg className="w-3.5 h-3.5 rtl:rotate-180 ltr:mr-1 rtl:ml-1" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path
                                                        d="M12.6644 5.47875L16.6367 9.00968C18.2053 10.404 18.9896 11.1012 18.9896 11.9993C18.9896 12.8975 18.2053 13.5946 16.6367 14.989L12.6644 18.5199C11.9484 19.1563 11.5903 19.4746 11.2952 19.342C11 19.2095 11 18.7305 11 17.7725V15.4279C7.4 15.4279 3.5 17.1422 2 19.9993C2 10.8565 7.33333 8.57075 11 8.57075V6.22616C11 5.26817 11 4.78917 11.2952 4.65662C11.5903 4.52407 11.9484 4.8423 12.6644 5.47875Z"
                                                        stroke="currentColor"
                                    ...
                                    <tr className="text-white-dark hover:text-black dark:hover:text-white-light/90 group">
                                        ...
                                        <td>66</td>
                                        <td>
                                            <Link className="flex items-center text-warning" to="/">
                                                <svg className="w-3.5 h-3.5 rtl:rotate-180 ltr:mr-1 rtl:ml-1" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path
                                                        d="M12.6644 5.47875L16.6367 9.00968C18.2053 10.404 18.9896 11.1012 18.9896 11.9993C18.9896 12.8975 18.2053 13.5946 16.6367 14.989L12.6644 18.5199C11.9484 19.1563 11.5903 19.4746 11.2952 19.342C11 19.2095 11 18.7305 11 17.7725V15.4279C7.4 15.4279 3.5 17.1422 2 19.9993C2 10.8565 7.33333 8.57075 11 8.57075V6.22616C11 5.26817 11 4.78917 11.2952 4.65662C11.5903 4.52407 11.9484 4.8423 12.6644 5.47875Z"
                                                        stroke="currentColor"
                                    ...
                                    <tr className="text-white-dark hover:text-black dark:hover:text-white-light/90 group">
                                        ...
                                        <td>35</td>
                                        <td>
                                            <Link className="flex items-center text-secondary" to="/">
                                                <svg className="w-3.5 h-3.5 rtl:rotate-180 ltr:mr-1 rtl:ml-1" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path
                                                        d="M12.6644 5.47875L16.6367 9.00968C18.2053 10.404 18.9896 11.1012 18.9896 11.9993C18.9896 12.8975 18.2053 13.5946 16.6367 14.989L12.6644 18.5199C11.9484 19.1563 11.5903 19.4746 11.2952 19.342C11 19.2095 11 18.7305 11 17.7725V15.4279C7.4 15.4279 3.5 17.1422 2 19.9993C2 10.8565 7.33333 8.57075 11 8.57075V6.22616C11 5.26817 11 4.78917 11.2952 4.65662C11.5903 4.52407 11.9484 4.8423 12.6644 5.47875Z"
                                                        stroke="currentColor"
